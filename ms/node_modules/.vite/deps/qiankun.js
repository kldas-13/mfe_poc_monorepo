        ...
        return regeneratorDefine(u2, "_invoke", function(r3, n3, o3) {
          ...
          function d(r4, n4) {
            for (c4 = r4, u3 = n4, t = 0; !y && f2 && !o4 && t < p.length; t++) {
              ...
              r4 > 3 ? (o4 = l2 === n4) && (u3 = i4[(c4 = i4[4]) ? 5 : (c4 = 3, 3)], i4[4] = i4[5] = e) : i4[0] <= d2 && ((o4 = r4 < 2 && d2 < i4[1]) ? (c4 = 0, G.v = n4, G.n = i4[1]) : d2 < l2 && (o4 = r4 < 3 || i4[0] > n4 || n4 > l2) && (i4[4] = r4, i4[5] = n4, G.n = l2, c4 = 0));
            }
          ...
          return function(o4, p2, l2) {
            ...
            for (y && 1 === p2 && d(p2, l2), c4 = p2, u3 = l2; (t = c4 < 2 ? e : u3) || !y; ) {
              ...
              try {
                if (f2 = 2, i3) {
                  ...
                  i3 = e;
                } else if ((t = (y = G.n < 0) ? u3 : r3.call(n3, G)) !== a2) break;
              } catch (t2) {
                i3 = e, c4 = 1, u3 = t2;
              } finally {
                f2 = 1;
...
var require_regeneratorRuntime = __commonJS({
  "node_modules/.pnpm/@babel+runtime@7.28.6/node_modules/@babel/runtime/helpers/regeneratorRuntime.js"(exports, module) {
    ...
    function _regeneratorRuntime8() {
      "use strict";
      var r = regenerator(), e = r.m(_regeneratorRuntime8), t = (Object.getPrototypeOf ? Object.getPrototypeOf(e) : e.__proto__).constructor;
      function n(r2) {
        ...
        return function(n2) {
          e2 || (e2 = {
            ...
            delegateYield: function delegateYield(r3, o2, a3) {
              return e2.resultName = o2, t2(n2.d, regeneratorValues(r3), a3);
            },
      ...
      return (module.exports = _regeneratorRuntime8 = function _regeneratorRuntime9() {
        return {
          wrap: function wrap(e2, t2, n2, o2) {
            return r.w(a2(e2), t2, n2, o2 && o2.reverse());
          },
          ...
          async: function async(r2, e2, t2, o2, u) {
            return (n(e2) ? regeneratorAsyncGen : regeneratorAsync)(a2(r2), e2, t2, o2, u);
          },
...
function shouldSkipProperty(global2, p) {
  if (!global2.hasOwnProperty(p) || !isNaN(p) && p < global2.length) return true;
  if (isIE11) {
    try {
      return global2[p] && typeof window !== "undefined" && global2[p].parent === window;
    } catch (err) {
      return true;
    }
  } else {
...
function getGlobalProp(global2) {
  ...
  for (var p in global2) {
    if (shouldSkipProperty(global2, p)) continue;
...
function getWrapperId(name) {
  return "__qiankun_microapp_wrapper_for_".concat((0, import_snakeCase.default)(name), "__");
}
...
function registerMicroApps(apps, lifeCycles) {
  ...
  unregisteredApps.forEach(function(app) {
    var name = app.name, activeRule = app.activeRule, _app$loader = app.loader, loader = _app$loader === void 0 ? import_noop4.default : _app$loader, props = app.props, appConfig = _objectWithoutProperties(app, _excluded2);
    bt({
      name,
      app: function() {
